...
const props = defineProps({
  stats: Object,
  filter: String // Kita butuh prop filter untuk tahu kapan harus hide badge
})
...
<template>
  <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
    ...
    <div class="relative overflow-hidden bg-gradient-to-br from-[#143d2e] to-[#258f62] rounded-[2rem] p-6 md:p-8 text-white shadow-xl shadow-green-900/10 hover:scale-[1.01] transition-transform duration-300">
      <p class="text-black-500 text-sm font-bold mb-2 uppercase tracking-wide">Total Volume</p>
    ...
    <div class="relative overflow-hidden bg-gradient-to-br from-[#143d2e] to-[#258f62] rounded-[2rem] p-6 md:p-8 text-white shadow-xl shadow-green-900/10 hover:scale-[1.01] transition-transform duration-300">
      <p class="text-black-500 text-sm font-bold mb-2 uppercase tracking-wide">Total Revenue</p>
    ...
    <div class="relative overflow-hidden bg-white text-black rounded-[2rem] p-6 md:p-8 shadow-xl hover:scale-[1.01] transition-transform duration-300 border border-gray-100">
