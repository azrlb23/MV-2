...
const menuItems = [
  ...
  { 
    name: 'Laporan', // Disesuaikan Labelnya
    route: '/laporan', // Disesuaikan Route-nya agar match dengan router/index.js
    // Icon: Dokumen Chart
  ...
  { 
    name: 'Bantuan IT', // Ganti Label
    route: '/support',  // Ganti Route
    // Icon: Lifebuoy (Pelampung/Bantuan)
    ...
    <div class="flex-1 flex flex-col h-full overflow-hidden relative w-full">
      ...
      <header class="flex-none flex items-center justify-between p-4 md:px-8 md:py-6 bg-[#f5f5f5] z-10">
        ...
        <div class="hidden md:flex items-center bg-gradient-to-r from-[#143d2e] to-[#1e5c45] rounded-full px-6 py-3 w-96 shadow-lg shadow-green-900/20">
          ...
          <input type="text" placeholder="Cari data..." class="bg-transparent text-white placeholder-white/70 outline-none w-full text-sm font-medium" />
        </div>
